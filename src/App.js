  ...
  return {
    ...
    signInOptions: [
      // TODO(developer): Remove the providers you don't need for your app.
      {
        ...
        clientId: firebase.auth().CLIENT_ID
      },
      {
      ...
      firebase.auth.GithubAuthProvider.PROVIDER_ID,
      {
        ...
        signInMethod: firebase.auth().getEmailSignInMethod()
      },
      {
        provider: firebase.auth.PhoneAuthProvider.PROVIDER_ID,
        recaptchaParameters: {
          size: firebase.auth().getRecaptchaMode()
        }
      },
      {
    ...
    credentialHelper:
      firebase.auth().CLIENT_ID &&
      firebase.auth().CLIENT_ID !== "YOUR_OAUTH_CLIENT_ID"
...
function getWidgetUrl() {
  return (
    "/widget#recaptcha=" +
    firebase.auth().getRecaptchaMode() +
    "&emailSignInMethod=" +
    firebase.auth().getEmailSignInMethod()
  );
}
...
function handleConfigChange() {
  ...
  firebase
    .auth()
    .location.replace(
      firebase.auth().location.pathname +
        "#recaptcha=" +
        newRecaptchaValue +
        "&emailSignInMethod=" +
...
var initApp = function () {
  ...
  firebase.auth().addEventListener("click", signInWithRedirect);
  document.getElementById("sign-in-with-popup");
  firebase.auth().addEventListener("click", signInWithPopup);
